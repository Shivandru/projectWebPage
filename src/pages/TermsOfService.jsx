...
export default function TermsOfService() {
  return (
    <Container maxW="6xl" h="auto" border="1px solid white">
      <Box mt="120px" borderBottom="1px solid #A0AEC0">
        <Heading fontSize="36px" fontWeight="400" mb="20px">
          Terms of Service
        </Heading>
      </Box>
      <Box>
        <Text fontSize="15px" fontWeight="200" color="#428BCA" mt="20px">
          Privacy
        </Text>
        <Heading fontSize="36px" fontWeight="400" mt="17px">
          Site Terms and Conditions of Use
        </Heading>
        <Text fontSize="15px" fontWeight="600" mt="10px">
          1. User's Acknowledgment and Acceptance of Terms
        </Text>
        <Text fontSize="14px" fontWeight="200" mt="10px">
          Gymwolf OÜ ("Us" or "We") provides the Gymwolf site and various
        ...
        <Text mt="10px" fontSize="14px">
          These Terms of Use are effective as of 01.09.2011. We expressly
        ...
        <Text mt="10px" fontSize="14px">
          ...
          limited to, Online gym workout log, and other like services. You are
          responsible for providing, at your own expense, all equipment
        ...
        <Text mt="10px" fontSize="14px">
          Copyright (c) 01.01.2020 Gymwolf OÜ All Rights Reserved.
        </Text>
        <Text mt="10px" fontSize="14px">
        ...
        <Text mt="10px" fontSize="14px">
          ...
          laws, and is the sole property of Gymwolf OÜ and/or its Affiliates.
        ...
        <Text mt="10px" fontSize="14px">
          ...
          of Gymwolf OÜ or its Affiliates: Gymwolf. All custom graphics, icons,
          logos and service names are registered trademarks, trademarks or
          service marks of Gymwolf OÜ or its Affiliates. All other trademarks or
          service marks are property of their respective owners. Nothing in
          these Terms of Use grants you any right to use any trademark, service
          mark, logo, and/or the name of Gymwolf OÜ or its Affiliates.
        </Text>
        <Text fontSize="15px" fontWeight="600" mt="10px">
        ...
        <Text mt="10px" fontSize="14px">
          Contact: -{"   "}
          Address: Narva mnt 9, Tartu, Estonia, 51009
        </Text>
        <Text mt="10px" fontSize="14px">
        ...
        <Text mt="10px" fontSize="14px">
          ...
          or statement made by anyone other than an authorized Gymwolf OÜ
        ...
        <Text mt="10px" fontSize="14px">
          ...
          offices within the Estonia, United States of America. It can be
          ...
          of Estonia, by accessing this site both of us agree that the statutes
          and laws of the State of Estonia, without regard to the conflicts of
          ...
          jurisdiction within the State of Estonia with respect to such matters.
        </Text>
        <Text fontSize="15px" fontWeight="600" mt="10px">
          17. Notices
        </Text>
        <Text mt="10px" fontSize="14px">
          ...
          attention of Customer Service at info@gymwolf.com, if by email, or at
          Gymwolf OÜ Narva mnt 9, Tartu, Estonia, 51009 if by conventional mail.
          Notices to you may be sent to the address supplied by you as part of
          your Registration Data. In addition, we may broadcast notices or
          messages through the site to inform you of changes to the site or
          other matters of importance, and such broadcasts shall constitute
        ...
        <Text mt="10px" fontSize="14px" mb="50px">
          Except as explicitly noted on this site, the services available
          through this site are offered by Gymwolf OÜ located at Narva mnt 9,
          Tartu, Estonia, 51009. If you notice that any user is violating these
          Terms of Use, please contact us at info@gymwolf.com.
        </Text>
      </Box>
    </Container>
  );
